	...
	<div class="nav justify-content-center">
		<ul style="display: flex; " class="list-unstyled">
			...
			while ($item = $result->fetch_assoc()): ?>
				<li><a class="btn btn-outline-danger lg" style="margin-left: 5px; text-decoration: none;"
						href='index.php?categoria=<?php echo $item['id'] ?>'>
						<?php echo $item['nome']; ?>
					</a></li>
			<?php endwhile; ?>
		</ul>
	...
	<div>
		...
		<form class="box-search" method="GET">
			...
			<button type="submit" name="pesquisar" value="Pesquisar" class="btn btn-primary">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-search"
					viewBox="0 0 16 16">
					<path
		...
		<div class="content">
						...
						<div class="col-md-3">
							<form method="post" action="cart.php?action=add&id=<?php echo $item["id"]; ?>">
								<div class="mypanel" align="center" ;>
									...
									<h5 class="text"><strong>R$
											<?php echo $item["price"]; ?>
										</strong></h5>
									<h6 class="text">Qtd.: <input type="number" min="1" max="25" name="quantity"
											class="form-control" value="1" style="width: 60px;"> </h6>
			...
			<a href="/Denilson/index.html" class="btn btn-primary" style="text-align: center; display: flex; justify-content: center; height: auto; margin-top: 1%;">Voltar para a página inicial</a>
