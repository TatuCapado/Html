...
// Cartão: Mastercard
?>`)
						var url = "https://api.whatsapp.com/send?phone=5521967663859&text=" + texto;
				...
				<h3 class="text-center" style="color:red"> <strong>Salve o numero do seu pedido ou envie-nos uma mensagem atraves do nosos whatsapp!! </strong>
